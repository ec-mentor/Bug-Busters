...
public class VolunteerActivityDTO {
    ...
    public VolunteerActivityDTO() {

    }

    public VolunteerActivityDTO(String title, String description, Status statusVolunteer, LocalDateTime startDate, LocalDateTime endDate, String role, String username, double rating, int myRatingToThem, String myFeedbackToThem, int theirRatingToMe, String theirFeedbackToMe) {
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        VolunteerActivityDTO that = (VolunteerActivityDTO) o;
